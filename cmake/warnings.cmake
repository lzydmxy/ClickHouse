...
if (COMPILER_CLANG)
    ...
    no_warning(inconsistent-missing-destructor-override)
    no_warning(shorten-64-to-32)
    no_warning(undef)
    no_warning(unused-parameter)
    no_warning(suggest-destructor-override)
    no_warning(gnu-zero-variadic-macro-arguments)
    no_warning(extra-semi)
    no_warning(cast-align)
    no_warning(zero-as-null-pointer-constant)
    no_warning(shadow)
    no_warning(shadow-field-in-constructor)
    no_warning(variadic-macros)
    no_warning(cast-qual)
    no_warning(unused-exception-parameter)
    no_warning(deprecated-declarations)
    no_warning(suggest-override)
    no_warning(deprecated-copy-with-user-provided-dtor)
    no_warning(used-but-marked-unused)
    no_warning(format-pedantic)
endif ()
