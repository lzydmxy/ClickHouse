...
void registerDiskNFS(DiskFactory & factory,  bool global_skip_access_check)
{
                      ...
                      const DisksMap & map) -> DiskPtr
    {
        ...
        LOG_TRACE(&Poco::Logger::get("registerDiskNFS"), "Disk name {}, root path {}, meta disk path {}", name, root_path, metadata_disk->getPath());
        ...
        disk_result->startup(context, skip_access_check);
