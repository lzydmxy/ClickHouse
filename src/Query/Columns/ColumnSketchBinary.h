...
/** Column for String values.
  */
class ColumnSketchBinary final : public COWHelper<IColumnHelper<ColumnSketchBinary>, ColumnSketchBinary>
{
public:
    using Char = UInt8;
...
private:
    friend class COWHelper<IColumnHelper<ColumnSketchBinary>, ColumnSketchBinary>;
...
#pragma GCC diagnostic ignored "-Wmaybe-uninitialized"
    ...
    {
        if (x.getType() != Field::Types::Which::SketchBinary)
            return false;
