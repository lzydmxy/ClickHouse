...
QueryPipeline InterpreterExplainQueryExt::executeImpl()
{
    const auto & ast = query->as<const ASTExplainQueryExt &>();
    ...
    switch (ast.getKind())
    {
        case ASTExplainQueryExt::ParsedAST:
        {
        ...
        case ASTExplainQueryExt::AnalyzedSyntax:
        {
        ...
        case ASTExplainQueryExt::QueryTree:
        {
        ...
        case ASTExplainQueryExt::QueryPlan:
        {
        ...
        case ASTExplainQueryExt::QueryPipeline:
        {
            if (dynamic_cast<const ASTSelectWithUnionQuery *>(ast.getExplainedQuery().get()))
            {
        ...
        case ASTExplainQueryExt::QueryEstimates:
        {
            if (!dynamic_cast<const ASTSelectWithUnionQuery *>(ast.getExplainedQuery().get()))
        ...
        case ASTExplainQueryExt::TableOverride:
        {
        ...
        case ASTExplainQueryExt::CurrentTransaction:
        {
            if (ast.getSettings())
