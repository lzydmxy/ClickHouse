...
bool ParserQueryExt::parseImpl(Pos & pos, ASTPtr & node, Expected & expected)
{
    ParserQueryWithOutputExt query_with_output_p(end, allow_settings_after_format_in_insert);
