...
/// Create CK object in gtest_protobuf_common then toProto() and fillFromProto()
/// TODO: Wait searialize to pb and desearialize from pb function in PlanSerDerHelper.h
