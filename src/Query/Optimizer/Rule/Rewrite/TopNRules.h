...
public:
    ...
    {
        return RuleType::CREATE_TOPN_FILTERING_FOR_AGGREGATING;
    }

    String getName() const override
    {
        return "CREATE_TOPN_FILTERING_FOR_AGGREGATING";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_TOPN_THROUGH_PROJECTION;
    }

    String getName() const override
    {
        return "PUSH_TOPN_THROUGH_PROJECTION";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_SORT_THROUGH_PROJECTION;
    }

    String getName() const override
    {
        return "PUSH_SORT_THROUGH_PROJECTION";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_TOPN_FILTERING_THROUGH_PROJECTION;
    }

    String getName() const override
    {
        return "PUSH_TOPN_FILTERING_THROUGH_PROJECTION";
    }
