...
namespace DB
{
    ...
    public:
        ...
        bool isEnabled(ContextPtr context) const override { return context->getOptimizerContext()->getSettingsRef().enable_push_union_through_join; }
    ...
    public:
        ...
        bool isEnabled(ContextPtr context) const override { return context->getOptimizerContext()->getSettingsRef().enable_push_union_through_projection; }
        ConstRefPatternPtr getPattern() const override;
    ...
    public:
        ...
        bool isEnabled(ContextPtr context) const override { return context->getOptimizerContext()->getSettingsRef().enable_push_union_through_agg; }
        ConstRefPatternPtr getPattern() const override;
