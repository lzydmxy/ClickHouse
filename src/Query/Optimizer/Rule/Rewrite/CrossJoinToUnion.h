...
public:
    ...
    bool isEnabled(ContextPtr context) const override { return context->getOptimizerContext()->getSettingsRef().enable_cross_join_to_union; }
...
private:
    static bool matchPattern(const JoinStepExt & step);
