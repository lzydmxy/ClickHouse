...
namespace DB
{
    ...
    public:
        ...
        bool isEnabled(ContextPtr context) const override { return context->getOptimizerContext()->getSettingsRef().enable_mark_distinct_optimzation; }
    ...
    private:
        ...
        static bool hasNoDistinctWithFilterOrMask(const AggregatingStepExt & step);
