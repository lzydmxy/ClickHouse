...
public:
    ...
    {
        return RuleType::PUSH_LIMIT_INTO_DISTINCT;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_INTO_DISTINCT";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_THROUGH_PROJECTION;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_THROUGH_PROJECTION";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_THROUGH_EXTREMES;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_THROUGH_EXTREMES";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_THROUGH_UNION;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_THROUGH_UNION";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_THROUGH_OUTER_JOIN;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_THROUGH_OUTER_JOIN";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::LIMIT_ZERO_TO_READNOTHING;
    }

    String getName() const override
    {
        return "LIMIT_ZERO_TO_READNOTHING";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_INTO_WINDOW;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_INTO_WINDOW";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_INTO_SORTING;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_INTO_SORTING";
    }
...
public:
    RuleType getType() const override
    {
        return RuleType::PUSH_LIMIT_THROUGH_BUFFER;
    }

    String getName() const override
    {
        return "PUSH_LIMIT_THROUGH_BUFFER";
    }
