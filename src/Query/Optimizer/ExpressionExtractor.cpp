...
Void ExpressionVisitor::visitProjectionStepExtNode(ProjectionStepExtNode & node, std::vector<ConstASTPtr> & expressions)
{
...
Void ExpressionVisitor::visitFilterStepExtNode(FilterStepExtNode & node, std::vector<ConstASTPtr> & expressions)
{
    const auto & step = *node.getStep();
...
Void ExpressionVisitor::visitAggregatingStepExtNode(AggregatingStepExtNode & node, std::vector<ConstASTPtr> & expressions)
{
    const auto & step = *node.getStep();
...
Void ExpressionVisitor::visitApplyStepExtNode(ApplyStepExtNode & node, std::vector<ConstASTPtr> & expressions)
{
    const auto & step = *node.getStep();
...
Void ExpressionVisitor::visitJoinStepExtNode(JoinStepExtNode & node, std::vector<ConstASTPtr> & expressions)
{
    const auto & step = *node.getStep();
