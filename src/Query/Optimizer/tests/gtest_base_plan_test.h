...
public:
    ...
    QueryPlanExtPtr plan(const String & query, ContextMutablePtr query_context);

    QueryPlanExtPtr plan(const String & query, const std::unordered_map<String, Field> & settings = {})
    {
