...
PlanNodePtr UseNodeProperty::ExchangeRewriter::visitCTERefStepExtNode(CTERefStepExtNode & node, Property & require)
{
...
PlanNodePtr UseNodeProperty::ExchangeRewriter::visitTableScanStepExtNode(TableScanStepExtNode & node, Property & require)
{
