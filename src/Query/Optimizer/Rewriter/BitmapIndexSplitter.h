...
private:
    bool isEnabled(ContextMutablePtr context) const override { return context->getOptimizerContext()->getSettingsRef().enable_bitmap_index_splitter; }
...
public:
    ...
    PlanNodePtr visitFilterStepExtNode(FilterStepExtNode & node, SplitterContext & context) override;
    PlanNodePtr visitProjectionStepExtNode(ProjectionStepExtNode & node, SplitterContext & context) override;
