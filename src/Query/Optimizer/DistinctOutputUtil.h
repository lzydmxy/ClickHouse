...
public:
    ...
    bool visitIntersectStepExtNode(IntersectStepExtNode & node, Void & context) override;
    ...
    bool visitExceptStepExtNode(ExceptStepExtNode & node, Void & context) override;
