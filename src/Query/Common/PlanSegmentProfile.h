...
struct ProfileMetric
{
    ...
    static ProfileMetricPtr fromProto(const RProfileMetric & proto);
    void toProto(RProfileMetric & proto);
...
public:
    ...
    static PlanSegmentProfilePtr fromProto(const RPlanSegmentProfileRequest & proto);
    void toProto(RPlanSegmentProfileRequest & proto);
