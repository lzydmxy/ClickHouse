...
Columns materializeColumns(const Block & block, const Names & names, const std::vector<bool> * null_safeColumns);
ColumnRawPtrs materializeColumnsInplace(Block & block, const Names & names, const std::vector<bool> * null_safeColumns);
...
ColumnRawPtrs extractKeysForJoin(Block & block_keys, const Names & key_names_right, const std::vector<bool> * null_safeColumns);
