...
#define CREATE_STATS_SETTINGS(M) \
    ...
    M(Float, sample_ratio, 0.001f, "Ratio for sampling", 0) \
...
#define AUTO_STATS_MANAGER_SETTINGS(M) \
    ...
    M(Float, update_ratio_threshold, 0.2f, "Threshold of minimal row count to trigger auto stats", 0) \
...
#define GET_SET(TYPE, NAME, DEFAULT_VALUE, EXPLAIN, INTERNAL) \
    ...
    public:
        ...
        void fromContextSettings(const OptimizerSettings
                                     & settings);
        void normalize();
