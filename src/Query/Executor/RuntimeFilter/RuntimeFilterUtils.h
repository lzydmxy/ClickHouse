...
{
    RuntimeFilterDescription(RuntimeFilterId id_, ASTPtr expr_, double filter_factor_, ASTs partition_columns_exprs_)
...
public:
    ...
    static ASTs createRuntimeFilterForFilter(const RuntimeFilterDescription & description, const String & query_id, bool only_bf);

    // RuntimeFilterBloomFilterExists will be at the end of std::vector<ASTPtr> .
    static ASTs createRuntimeFilterForTableScan(
