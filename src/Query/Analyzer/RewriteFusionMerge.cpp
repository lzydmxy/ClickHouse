...
void RewriteFusionMerge::visit(ASTTableExpression & table_expr, ASTPtr &)
{
    ...
    if (table_args.size() != 7)
        throw Exception(ErrorCodes::NUMBER_OF_ARGUMENTS_DOESNT_MATCH, "Table function 'fusionMerge' requires exactly 7 arguments");
    ...
    select_union_query->union_mode = SelectUnionMode::UNION_ALL;
