 ...
 */
class FinishAggregatingInOrderAlgorithmExt final : public IMergingAlgorithm
{
public:
    FinishAggregatingInOrderAlgorithmExt(
        const Block & header_,
        size_t num_inputs_,
...
private:
    ...
    struct State
    {
        ...
        State(const Chunk & chunk, const SortDescriptionWithPositions & description);
