...
MarkDistinctTransformExt::MarkDistinctTransformExt(const Block & header_, String marker_symbol_, std::vector<String> distinct_symbols_)
    ...
    , distinct_set(SizeLimits{}, true, true)
{
    ...
    distinct_set.setHeader(mark_distinct_block.getColumnsWithTypeAndName());
}

void MarkDistinctTransformExt::transform(Chunk & chunk)
{
    ...
    //TODO: zhangdongdong92, need distinct_set
