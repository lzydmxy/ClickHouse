...
class TopNFilteringTransformExt : public ISimpleTransform
{
public:
    TopNFilteringTransformExt(const Block & header_, SortDescription sort_description_, UInt64 size_, TopNModel model_);
...
class TopNFilteringByLimitingTransformExt : public TopNFilteringTransformExt
{
public:
...
class TopNFilteringByHeapTransformExt : public TopNFilteringTransformExt
{
public:
