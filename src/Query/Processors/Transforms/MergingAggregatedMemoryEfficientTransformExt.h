...
class GroupingAggregatedTransformExt : public IProcessor
{
public:
    GroupingAggregatedTransformExt(const Block & header_, size_t num_inputs_, AggregatingTransformParamsExtPtr params_);
    String getName() const override { return "GroupingAggregatedTransformExt"; }
...
class MergingAggregatedBucketTransformExt : public ISimpleTransform
{
public:
    explicit MergingAggregatedBucketTransformExt(AggregatingTransformParamsExtPtr params);
    String getName() const override { return "MergingAggregatedBucketTransformExt"; }
...
class SortingAggregatedTransformExt : public IProcessor
{
public:
    SortingAggregatedTransformExt(size_t num_inputs, AggregatingTransformParamsExtPtr params);
    String getName() const override { return "SortingAggregatedTransformExt"; }
    Status prepare() override;
...
struct ChunksToMergeExt : public ChunkInfo
{
