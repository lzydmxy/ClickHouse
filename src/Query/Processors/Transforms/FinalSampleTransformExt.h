...
class FinalSampleTransformExt : public IProcessor
{
public:
    FinalSampleTransformExt(const Block & header, size_t sample_size, size_t max_chunk_size, size_t num_streams = 1);

    String getName() const override { return "FinalSampleTransformExt"; }
