...
FilterTransformExt::FilterTransformExt(
    const Block & header_,
    ...
    bool dynamic_)
    : FilterTransform(header_, expression_, filter_column_name_, remove_filter_column_, on_totals_, rows_filtered_)
    , dynamic(dynamic_)
{
}

void FilterTransformExt::transform(Chunk & chunk)
{
...
void FilterTransformExt::doTransform(Chunk & chunk)
{
