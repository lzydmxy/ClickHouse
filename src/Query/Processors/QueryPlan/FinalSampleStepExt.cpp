...
{
    //todo: hongzhigao, other feat: need impl ITransformingStep::serializeToProtoBase
...
{
    //todo: hongzhigao, other feat: need impl ITransformingStep::deserializeFromProtoBase
    //auto [step_description, base_input_stream] = ITransformingStep::deserializeFromProtoBase(proto.query_plan_base());
    String step_description;
    DataStream base_input_stream;
