...
public:
    ...
    static QueryPlanExtPtr getPlanFromCache(UInt128 query_hash, ContextMutablePtr & context);
    static bool addPlanToCache(UInt128 query_hash, QueryPlanExtPtr & plan, AnalysisPtr analysis, ContextMutablePtr & context);
